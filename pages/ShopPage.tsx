...
const ShopPage: React.FC = () => {
    ...
    useEffect(() => {
        console.log("%c Clube do Seu Bolso App Version: 4.5.4 - Strict Tenant Isolation ", "background: #2980B9; color: #0B1221; font-weight: bold; padding: 4px; border-radius: 4px;");
        fetchCategories();
    }, []);
                    ...
                    <aside className="w-full lg:w-72 space-y-6 flex-shrink-0">
                        ...
                        <div className="space-y-3 pt-4 border-t border-slate-100">
                            ...
                            <div className="grid grid-cols-2 gap-2">
                                <input
                                    ...
                                    className="w-full bg-slate-50 border border-slate-100 rounded-lg p-2 text-xs outline-none focus:border-[#2980B9]"
                                />
                                <input
                                    type="number"
                                    placeholder="Máx"
                        ...
                        <div className="flex items-center gap-2 pt-2">
                            <input
                                ...
                                className="w-4 h-4 rounded border-slate-200 text-[#2980B9] focus:ring-[#2980B9]"
                            />
                            ...
                            <div className="flex flex-col md:flex-row md:items-center justify-between gap-6 bg-white p-4 rounded-xl border border-slate-100 shadow-sm">
                                <form onSubmit={handleSearch} className="relative max-w-sm w-full">
                                    <input
                                        ...
                                        className="w-full bg-slate-50 rounded-lg py-2.5 px-10 outline-none focus:ring-2 focus:ring-[#2980B9]/50 text-sm border border-slate-100"
                                    />
                                ...
                                <div className="w-full overflow-hidden">
                                    ...
                                    {products.map(product => (
                                        <div
                                            ...
                                            className="group bg-white rounded-2xl border border-slate-100 overflow-hidden hover:shadow-xl hover:shadow-[#2980B9]/10 transition-all duration-300 cursor-pointer flex flex-col h-full"
                                        >
                                                ...
                                                />
                                                 <div className="absolute top-4 right-4 flex flex-col gap-2">
                                                    ...
                                                    <div
                                                        ...
                                                        className={`bg-white shadow-md rounded-full p-2 -translate-y-12 opacity-0 group-hover:translate-y-0 group-hover:opacity-100 transition-all delay-75 cursor-pointer relative ${copiedId === product.id ? 'text-emerald-500' : 'text-[#0B1221] hover:text-[#2980B9]'}`}
                                                    >
                                            ...
                                            <div className="p-6 flex flex-col flex-grow space-y-3">
                                                ...
                                                <h3 className="font-bold text-[#0B1221] leading-tight group-hover:text-[#2980B9] transition-colors line-clamp-2 min-h-[2.5rem] break-words">{product.name}</h3>
                                                <p
                                                ...
                                                <div className="mt-auto pt-2">
                                                    ...
                                                    <button
                                                        ...
                                                        className={`w-full py-3 rounded-xl text-[10px] font-black uppercase tracking-widest flex items-center justify-center gap-2 transition-all ${
                                                            (product.stock_quantity ?? 0) > 0 
                                                            ? 'bg-slate-50 border border-slate-100 text-[#0B1221] group-hover:bg-[#2980B9] group-hover:border-[#2980B9]' 
                                ...
                                {[...Array(totalPages)].map((_, i) => {
                                    ...
                                    return (
                                        <button
                                            ...
                                            className={`w-10 h-10 rounded-lg font-bold transition-all ${currentPage === page ? 'bg-[#2980B9] text-[#0B1221]' : 'border border-slate-200 text-slate-400 hover:border-[#2980B9] hover:text-[#2980B9]'}`}
                                        >
                                            {page}
                                        </button>
                                    );
                        ...
                        {!isLoading && products.length === 0 && (
                            <div className="text-center py-20 px-4">
                                ...
                                <button
                                    ...
                                    className="mt-6 text-[#2980B9] font-bold hover:underline"
                                >
