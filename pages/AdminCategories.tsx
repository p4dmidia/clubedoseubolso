                    ...
                    <div className="bg-white rounded-[2rem] border border-slate-100 shadow-sm overflow-hidden transition-all hover:shadow-md">
                        <div className="p-6 flex items-center justify-between">
                            <div className="flex items-center gap-4">
                                <div className="w-10 h-10 bg-slate-50 rounded-xl border border-slate-100 flex items-center justify-center text-[#2980B9]">
                            ...
                            <div className="flex items-center gap-2">
                                <button
                                    ...
                                    className="p-2 text-slate-400 hover:text-[#2980B9] hover:bg-slate-100 rounded-lg transition-all"
        ...
        <AdminLayout>
            <div className="space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-700">
                ...
                <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
                    ...
                    >
                        <Plus className="w-4 h-4 text-[#2980B9]" />
                        Nova Categoria
                    </button>
                </div>
                    ...
                    <div className="bg-white w-full max-w-lg rounded-[3rem] shadow-2xl relative z-10 overflow-hidden animate-in zoom-in-95 duration-300">
                        <form onSubmit={handleSaveCategory} className="flex flex-col h-full">
                            <div className="p-8 md:p-10 border-b border-slate-50 flex justify-between items-center">
                                <div>
                                    <p className="text-[10px] font-black uppercase text-[#2980B9] tracking-widest mb-1">Catálogo</p>
                            ...
                            <div className="p-8 md:p-10 space-y-8 overflow-y-auto max-h-[70vh]">
                                <div className="space-y-3">
                                    ...
                                    <input
                                        ...
                                        className="w-full bg-slate-50 border border-slate-100 rounded-2xl py-5 px-6 font-bold text-[#05080F] outline-none focus:border-[#2980B9] focus:bg-white text-base md:text-lg transition-all shadow-sm"
                                ...
                                <div className="space-y-3">
                                    <label className="text-[10px] font-black uppercase text-slate-400 tracking-widest pl-1 flex items-center gap-2">
                                        <Layers className="w-3 h-3" /> Categoria Pai (Opcional)
                                    </label>
                                    <div className="relative">
                                        <select
                                            value={parentCategoryId || ''}
                                            onChange={(e) => setParentCategoryId(e.target.value ? parseInt(e.target.value) : null)}
                                            className="w-full bg-slate-50 border border-slate-100 rounded-2xl py-5 px-6 font-bold text-[#05080F] outline-none focus:border-[#2980B9] focus:bg-white text-base transition-all shadow-sm appearance-none"
                                        >
                            ...
                            <div className="p-8 md:p-10 bg-slate-50/50 border-t border-slate-50 mt-auto">
                                <button
                                    type="submit"
                                    disabled={isSaving}
                                    className="w-full py-5 bg-[#05080F] text-white rounded-[1.5rem] font-black text-sm md:text-base shadow-xl shadow-[#05080F]/10 hover:bg-[#2980B9] hover:text-[#05080F] transition-all flex items-center justify-center gap-3 disabled:opacity-50 uppercase tracking-widest"
                                >
                                    {isSaving ? (
                                        <>
