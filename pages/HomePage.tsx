...
const HomePage: React.FC = () => {
    ...
    return (
        <div className="bg-white text-slate-800 font-sans overflow-x-hidden selection:bg-[#2980B9]/20">
            ...
            <header className="relative pt-12 md:pt-20 pb-16 overflow-hidden bg-gradient-to-b from-slate-50 via-white to-white">
                ...
                <div className="max-w-[1200px] mx-auto px-6 grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
                    ...
                    <div className="lg:col-span-5 flex justify-center lg:justify-end">
                        <div className="relative w-full max-w-[480px] aspect-video rounded-[2rem] overflow-hidden shadow-2xl border-4 border-white bg-[#0B1221]">
                            <video 
            ...
            <a
                href="https://api.whatsapp.com/send/?phone=5571999772129&text=Ol%C3%A1!+Gostaria+de+tirar+d%C3%BAvidas+sobre+o+Clube+do+Seu+Bolso.&type=phone_number&app_absent=0"
                target="_blank"
                rel="noopener noreferrer"
                aria-label="Falar pelo WhatsApp"
                className="fixed bottom-6 right-6 z-50 flex items-center gap-3 bg-[#25D366] hover:bg-[#20ba5a] text-white p-3.5 sm:px-5 sm:py-3.5 rounded-full shadow-2xl hover:shadow-green-500/40 transition-all duration-300 transform hover:scale-105 group"
            >
                ...
                <span className="hidden sm:inline-block font-black text-xs uppercase tracking-wider shadow-sm">
                    Fale Conosco
                </span>
            </a>
        </div>
