      ...
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-20">
          <div className="space-y-6">
            ...
            <div className="flex gap-4">
              <a href="#" className="w-10 h-10 rounded-full bg-slate-50 flex items-center justify-center text-slate-400 hover:text-[#2980B9] transition-colors">
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm text-slate-500">
              <li><a href="/shop" className="hover:text-[#2980B9] transition-colors">Telemedicina</a></li>
              <li><a href="/shop" className="hover:text-[#2980B9] transition-colors">Energia por Assinatura</a></li>
              <li><a href="/shop" className="hover:text-[#2980B9] transition-colors">Estratégias de Crédito</a></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm text-slate-500">
              ...
              <li><a href="#" className="hover:text-[#2980B9] transition-colors">Seja um Afiliado</a></li>
            ...
            <div className="mt-8 bg-[#2980B9] p-6 rounded-[2rem] shadow-xl shadow-blue-900/10 relative overflow-hidden group">
              ...
              <div className="relative z-10">
                ...
                <a 
                  ...
                  className="block w-full bg-white text-black text-center py-3 rounded-xl font-black text-[10px] uppercase tracking-widest hover:bg-black hover:text-white transition-all shadow-sm"
                >
                  Falar no WhatsApp
                </a>
              </div>
        ...
        <div className="border-t border-slate-100 py-10 flex flex-col md:flex-row items-center justify-between gap-8">
          <p className="text-slate-400 text-xs">
            © 2024 Clube do Seu Bolso Gold. Todos os direitos reservados.
          </p>
        </div>
      </div>
    </footer>
