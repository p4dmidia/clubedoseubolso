        ...
        WHILE v_gen_count < v_active_gens AND v_current_sponsor_id IS NOT NULL LOOP
            ...
            IF v_commission_amount IS NOT NULL AND v_commission_amount > 0 THEN
                ...
                IF v_target_user_id IS NOT NULL THEN
                    -- Check if this is Level 1 and was paid via Asaas Split
                    IF v_gen_count = 1 AND NEW.split_amount > 0 AND NEW.split_wallet_id IS NOT NULL THEN
                        ...
                        INSERT INTO public.commissions (
                            ...
                            v_gen_count,
                            v_config.type,
                            'Comissão Geração 1 paga automaticamente via Split Asaas - Pedido ' || NEW.id
                        );
                    ELSE
                        -- Traditional flow: Update balances
