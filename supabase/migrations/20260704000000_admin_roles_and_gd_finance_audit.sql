-- Migration: Support admin_gerente role in administrative functions and RLS policies
-- Date: 2026-07-04

-- 1. Update public.is_admin() to include 'admin_gerente'
...
-- 2. Update public.admin_create_user() to permit execution by 'admin_gerente'
...
-- 3. Standardize RLS Policies on public.admin_audit_logs to use is_admin()
...
-- 4. Standardize RLS Policies on public.anti_fraud_logs to use is_admin()
